...
## DB
Czy sa jakeis znane sposoby na przechowywyanie danych z czujnikow jako lista? Czy sa jakeis sugestie odnosnie bazy danych.


Myslimy o laowaniu najpierw do tablic na ram a ptoem po zakonczeniu naywania o bazki kopiowac listy 
czy to ok?
czy od razu do bazki ladowac
...
Wydaje sie ze lepiej dziala TimeStamp z wbudowanymi algorytami
...
# Na Jakim etapi pracy jest backend?
