...
namespace TupTrack.Tests.Application
{
    public class SensorServiceTests
    {
        ...
        public void SensorService_AddingValues_ShouldEnumerableProperValuesWithDifferentDates(int[] values)
        {
        ...
        [Fact]
        public void SensorService_InitializedAmountGreaterThanTablesAmount_ShouldNotThrow()
        {
            var ex = Record.Exception(() => new TestSensorService(tablesAmount: 2, initializedAmount: 10, tableSize: 1));
